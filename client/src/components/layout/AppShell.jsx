...
export default function AppShell({ activeNav = "dashboard", onNavChange, children }) {
    ...
    return (
        <div className="app-background min-h-screen">
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-40 flex w-64 transform flex-col border-r border-white/10 bg-[var(--plum-950)] text-white transition-transform lg:translate-x-0 ${
            ...
            >
                ...
                <div className="shrink-0 space-y-3 border-t border-white/10 bg-[var(--plum-950)] px-4 py-4">
